class Headers:
    ...
    def header_5d(self, spectrum_name):
        header = str(self.top_header
                  + f"#INAME\t1\t{self.dimension1}\n"
                  + f"#INAME\t2\t{self.dimension2}\n"
                  + f"#INAME\t3\t{self.dimension3}\n"
                  + f"#INAME\t4\t{self.dimension4}\n"
                  + f"#INAME\t5\t{self.dimension5}\n"
                  + f"#SPECTRUM {spectrum_name} {self.dimension1} {self.dimension2} {self.dimension3} {self.dimension4} {self.dimension5}\n"
                  )
        return header
    ...
    def create_header(self):
        ...
        if self.dimensions == 2:
            ...
            return self.header_5d(self.spectrum_name)
