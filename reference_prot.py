...
# Generates .prot reference files that work with Flya
# CCPN -> Export as .nef -> Poky -> Universal NMR Formats -> NEF Chemical Shifts to Sparky Resonance List
# The file generated by Poky on this way serves as the input for this script (poky_output_file_path)
...
# if you need to adjust the number of the amino acids in the chain
